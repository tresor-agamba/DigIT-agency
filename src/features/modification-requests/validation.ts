...
export const updateRequestSchema=z.object({id:idSchema,status:z.enum(["IN_PROGRESS","COMPLETED","REJECTED"]),adminResponse:z.string().trim().max(2000).optional().transform(v=>v||undefined)});
